        ...
        <div className="row align-items-start">
          <div className="col-8">
            {query ? (
              ...
              <p>
                <strong>No more query to evaluate.</strong>
                <br />
                Thank you!
              </p>
            )}
            ...
            <div className="col-4 rs-Queries-actions">
              ...
              <div className="text-center">
                <button
                  type="button"
                  className={`btn ${
                    choice && choice === "IRRELEVANT"
                      ? "btn-danger"
                      : "btn-outline-danger"
                  }`}
                  onClick={() => this.onIrrelevantClicked()}
                >
                  Irrelevant
                </button>
                &nbsp;&nbsp;
                <button
                  type="button"
                  className={`btn ${
                    choice && choice === "MISPLACED"
                      ? "btn-warning"
                      : "btn-outline-warning"
                  }`}
                  onClick={() => this.onMisplacedClicked()}
                >
                  Misplaced
                </button>
                &nbsp;&nbsp;
                <button
                  ...
                  onClick={() => this.onRelevantClicked()}
                >
                  Relevant
                </button>
              </div>
              {choice && choice !== "RELEVANT" && (
                <React.Fragment>
                  <div className="form-group mt-4">
                    <label htmlFor="issueDescription" className="mb-1">
                      What is the issue?*
                    </label>
                    <textarea
                    ...
                    />
                    <small>
                      <u>Mandatory</u>. Don't forget to include item #.
                    </small>
                  </div>
                  <br />
                  <div className="text-center mt-4 mb-2">
                    <button
                      ...
                      onClick={() => this.onIDontKnowClicked()}
                    >
                      I don't know
                    </button>
                    <button
                      ...
                      onClick={() => this.onNextQueryClicked()}
